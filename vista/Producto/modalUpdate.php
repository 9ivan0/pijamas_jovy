...
<div class="modal fade" id="actualizarModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <form class="form2" id="frminsertu" onsubmit="return actualizarDatos()" method="post">
    ...
    <br>
    <div class="one-half ">
      <input type="text" id="productou" name="productou" minlength="3" maxlength="30" required=""><span class="barra"></span>
      <label>Nombre del producto</label>
    </div>
    <div class="one-half last">
      <input type="text" id="preciou" name="preciou" minlength="5" maxlength="5" required=""><span class="barra"></span>
    ...
    <div class="one-half last">
      <input type="text" id="tallau" name="tallau"  maxlength="20" required=""><span class="barra"></span>
      <label>Tallas</label>
    </div>
    <div class="one-half ">
