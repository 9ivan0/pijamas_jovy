...
<div class="modal fade" id="insertarModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
         ...
         <h1>Registro Producto</h1><br><br><br>
              ...
              <input type="text" id="producto" name="producto" minlength="3" maxlength="30" required=""><span class="barra"></span>
              <label>Nombre del producto</label>
              </div> 
              <div class="one-half last ">
              <input type="num" id="precio" name="precio" minlength="5" maxlength="5" required=""><span class="barra"></span>
              ...
              <div class="one-half last ">
              <input type="text" id="talla" name="talla"  maxlength="20" required=""><span class="barra"></span>
              <label>Tallas</label>
              </div>
              <div class="one-half ">
