		...
		<div class="row">
			<h1 class="h">Material</h1>
						...
						<div class="well well-sm text-right">
					            <a class=" btn btn-info" href="../../modelo/reportes/material.php" target="_blank"> Generar reporte </a>
					            <a class=" btn btn-info" href="../../modelo/reportes/material.php" download="reporteus">Descargar reporte </a>
				            </div>
					</div>
				</div>
			</div>
